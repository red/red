...
Or you can compile the Red console from source:
...
If you want to contribute code to the Red project be sure to read the document

	https://github.com/red/red/wiki/Contributor-Guidelines

When you change any of the code from the Red sources itself, you can use these changed sources to compile your Red (test)programs in the same way as above when compiling the Red Console.
 
Satisfied with the results of your change and want to issue a pull request on Github make sure the changes pass the tests? 
Remember to add relevant tests to the testsuite. Please test on as many platforms as you can, using:

        >> do %run-all.r 

Depending on what computer you are running the tests, the entire testsuite can take about 15 to 30 minutes to complete. 
(Note: this is just an indication).
