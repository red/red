...
#import [
	LIBC-file cdecl [
		...
		objc_msgSend: "objc_msgSend" [[variadic keep] return: [integer!]]
		objc_msgSend_pt: "objc_msgSend" [[variadic keep] return: [CGPoint! value]]
		objc_msgSend_sz: "objc_msgSend" [[variadic keep] return: [NSSize! value]]
		objc_msgSend_range: "objc_msgSend" [[variadic keep] return: [NSRange! value]]
		objc_msgSendSuper: "objc_msgSendSuper" [[variadic keep] return: [integer!]]
		objc_msgSend_f32: "objc_msgSend_fpret" [[variadic keep] return: [float32!]]
		objc_msgSend_fpret: "objc_msgSend_fpret" [[variadic keep] return: [float!]]
		objc_msgSend_stret: "objc_msgSend_stret" [[custom]]
		objc_msgSend_rect: "objc_msgSend_stret" [[variadic keep] return: [NSRect! value]]
