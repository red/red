...
===start-group=== "Datatype tests"
  ...
  if all [qt/compile-target any [find qt/compile-target "X86-64" find qt/compile-target "ARM64"]] [--run-test-file-quiet %source/units/struct-x64-test.reds]
  unless all [qt/compile-target any [find qt/compile-target "X86-64" find qt/compile-target "ARM64"]] [--run-test-file-quiet %source/units/struct-test.reds]
