Red/System [Title: "Static link: Mach-O libc trampoline (memcpy)"]
...
;-- copy_and_return_len relays through memcpy in libc.dylib via trampoline
...
either all [n = 6  sum = 405][
	print "PASS: static link Mach-O memcpy^/"
][
	print "FAIL: static link Mach-O memcpy^/"
]
