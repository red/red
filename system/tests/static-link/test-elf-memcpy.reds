Red/System [Title: "Static link: ELF libc trampoline (memcpy)"]
...
;-- copy_and_return_len relays through memcpy in libc.so.6 via trampoline
...
either all [n = 6  sum = 405][
	print "PASS: static link ELF memcpy^/"
][
	print "FAIL: static link ELF memcpy^/"
]
