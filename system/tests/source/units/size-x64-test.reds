Red/System [
	Title:   "Red/System x86-64 SIZE? function test script"
	Author:  "Nenad Rakocevic"
	File: 	 %size-x64-test.reds
	Tabs:	 4
...
===start-group=== "Size of datatypes"
	...
	--test-- "type-sz-4" --assert 8 = size? pointer!
	--test-- "type-sz-5" --assert 8 = size? c-string!
	--test-- "type-sz-6" --assert 8 = size? struct!
	--test-- "type-sz-7" --assert 8 = size? function!
...
===start-group=== "Size of literals and global variables"
	...
	--assert 16 = size? sz-struct5

	--test-- "sz-16"
	sz-struct!: alias struct! [a [integer!] b [c-string!]]
	--assert 16 = size? sz-struct!
