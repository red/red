...
===start-group=== "IEEE754 compliance in NaN handling - float! type"
	...
	cmp-lesser: func [a [float!] b [float!] return: [logic!]] [a < b]
	cmp-greater: func [a [float!] b [float!] return: [logic!]] [a > b]
	...
	icmp-lesser: func [a [float!] b [float!] return: [integer!]] [as integer! a < b]
	icmp-greater: func [a [float!] b [float!] return: [integer!]] [as integer! a > b]
	...
	ecmp-lesser: func [c [logic!] a [float!] b [float!] return: [logic!]] [either c [a < b][a >= b]]
	ecmp-greater: func [c [logic!] a [float!] b [float!] return: [logic!]] [either c [a > b][a <= b]]
