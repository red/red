...
context [
	...
	;-- State ------------- Predicted type ----
		...
		S_DECX				TYPE_FLOAT			;-- 23
		S_DEC_SPECIAL		TYPE_FLOAT			;-- 24
		S_TUPLE				TYPE_TUPLE			;-- 25
		S_DATE				TYPE_DATE			;-- 26
		S_TIME_1ST			TYPE_TIME			;-- 27
		S_TIME				TYPE_TIME			;-- 28
		S_PAIR_1ST			TYPE_PAIR			;-- 29
		S_PAIR				TYPE_PAIR			;-- 30
		S_MONEY_1ST			TYPE_MONEY			;-- 31
		S_MONEY				TYPE_MONEY			;-- 32
		S_MONEY_DEC			TYPE_MONEY			;-- 33
		S_HEX				TYPE_INTEGER		;-- 34
		S_HEX_END			TYPE_WORD			;--	35
		S_HEX_END2			TYPE_INTEGER		;--	36
		S_LESSER			TYPE_TAG			;-- 37
		S_TAG				TYPE_TAG			;-- 38
		S_TAG_STR			TYPE_TAG			;-- 39
		S_TAG_STR2			TYPE_TAG			;-- 40
		S_SIGN				TYPE_WORD			;-- 41
