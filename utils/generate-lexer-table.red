...
context [
	...
	;-- State ------------- Predicted type ----
		...
		S_URL_1ST			TYPE_URL			;-- 54
		S_URL				TYPE_URL			;-- 55
		S_EMAIL				TYPE_EMAIL			;-- 56
		S_REF				TYPE_REF			;-- 57
		S_IPV6_1ST			TYPE_IPV6			;-- 58
		S_IPV6				TYPE_IPV6			;-- 59
		S_EQUAL				TYPE_WORD			;-- 60
		S_PATH				TYPE_PATH			;-- 61
		S_PATH_NUM			TYPE_INTEGER		;--	62
		S_PATH_W1ST			TYPE_WORD			;-- 63
		S_PATH_WORD			TYPE_WORD			;-- 64
		S_PATH_SHARP		TYPE_ISSUE			;--	65
		S_PATH_SIGN			TYPE_WORD			;--	66
		--EXIT_STATES--		-					;-- 67
		T_EOF				-					;-- 68
		T_ERROR				TYPE_ERROR			;-- 69
		T_BLK_OP			-					;-- 70
		T_BLK_CL			-					;-- 71
		T_PAR_OP			-					;-- 72
		T_PAR_CL			-					;-- 73
		T_MSTR_OP			-					;-- 74
		T_MSTR_CL			TYPE_STRING			;-- 75
		T_MAP_OP			-					;-- 76
		T_PATH				-					;-- 77
		T_CONS_MK			-					;-- 78
		T_CMT				-					;-- 79
		T_COMMA				-					;-- 80
		T_STRING			TYPE_STRING			;-- 81
		T_WORD				TYPE_WORD			;-- 82
		T_ISSUE				TYPE_ISSUE			;-- 83
		T_INTEGER			TYPE_INTEGER		;-- 84
		T_REFINE			TYPE_REFINEMENT		;-- 85
		T_CHAR				TYPE_CHAR			;-- 86
		T_FILE				TYPE_FILE			;-- 87
		T_BINARY			TYPE_BINARY			;-- 88
		T_PERCENT			TYPE_PERCENT		;-- 89
		T_FLOAT				TYPE_FLOAT			;-- 90
		T_FLOAT_SP			TYPE_FLOAT			;-- 91
		T_TUPLE				TYPE_TUPLE			;-- 92
		T_DATE				TYPE_DATE			;-- 93
		T_PAIR				TYPE_PAIR			;-- 94
		T_POINT				TYPE_POINT2D		;-- 95
		T_TIME				TYPE_TIME			;-- 96
		T_MONEY				TYPE_MONEY			;-- 97
		T_TAG				TYPE_TAG			;-- 98
		T_URL				TYPE_URL			;-- 99
		T_EMAIL				TYPE_EMAIL			;-- 100
		T_HEX				TYPE_INTEGER		;-- 101
		T_RAWSTRING			TYPE_STRING			;-- 102
		T_REF				TYPE_REF			;-- 103
		T_IPV6				TYPE_IPV6			;-- 104
	]
