...
context [
	...
	;-- State ------------- Predicted type ----
		...
		S_REF				TYPE_REF			;-- 57
		S_EQUAL				TYPE_WORD			;-- 58
		S_PATH				TYPE_PATH			;-- 59
		S_PATH_NUM			TYPE_INTEGER		;--	60
		S_PATH_W1ST			TYPE_WORD			;-- 61
		S_PATH_WORD			TYPE_WORD			;-- 62
		S_PATH_SHARP		TYPE_ISSUE			;--	63
		S_PATH_SIGN			TYPE_WORD			;--	64
		--EXIT_STATES--		-					;-- 65
		T_EOF				-					;-- 66
		T_ERROR				TYPE_ERROR			;-- 67
		T_BLK_OP			-					;-- 68
		T_BLK_CL			-					;-- 69
		T_PAR_OP			-					;-- 70
		T_PAR_CL			-					;-- 71
		T_MSTR_OP			-					;-- 72
		T_MSTR_CL			TYPE_STRING			;-- 73
		T_MAP_OP			-					;-- 74
		T_PATH				-					;-- 75
		T_CONS_MK			-					;-- 76
		T_CMT				-					;-- 77
		T_COMMA				-					;-- 78
		T_STRING			TYPE_STRING			;-- 79
		T_WORD				TYPE_WORD			;-- 80
		T_ISSUE				TYPE_ISSUE			;-- 81
		T_INTEGER			TYPE_INTEGER		;-- 82
		T_REFINE			TYPE_REFINEMENT		;-- 83
		T_CHAR				TYPE_CHAR			;-- 84
		T_FILE				TYPE_FILE			;-- 85
		T_BINARY			TYPE_BINARY			;-- 86
		T_PERCENT			TYPE_PERCENT		;-- 87
		T_FLOAT				TYPE_FLOAT			;-- 88
		T_FLOAT_SP			TYPE_FLOAT			;-- 89
		T_TUPLE				TYPE_TUPLE			;-- 90
		T_DATE				TYPE_DATE			;-- 91
		T_PAIR				TYPE_PAIR			;-- 92
		T_POINT				TYPE_POINT2D		;-- 93
		T_TIME				TYPE_TIME			;-- 94
		T_MONEY				TYPE_MONEY			;-- 95
		T_TAG				TYPE_TAG			;-- 96
		T_URL				TYPE_URL			;-- 97
		T_EMAIL				TYPE_EMAIL			;-- 98
		T_HEX				TYPE_INTEGER		;-- 99
		T_RAWSTRING			TYPE_STRING			;-- 100
		T_REF				TYPE_REF			;-- 101
	]
