...
context [
	...
	;-- State ------------- Predicted type ----
		...
		S_HEX_END2			TYPE_INTEGER		;--	35
		S_LESSER			TYPE_TAG			;-- 36
		S_TAG				TYPE_TAG			;-- 37
		S_TAG_STR			TYPE_TAG			;-- 38
		...
		T_PAR_CL			-					;-- 60
		T_MSTR_OP			-					;-- 61
		T_MSTR_CL			TYPE_STRING			;-- 62
		T_MAP_OP			-					;-- 63
		T_PATH				-					;-- 64
		T_CONS_MK			-					;-- 65
		T_CMT				-					;-- 66
		T_INTEGER			TYPE_INTEGER		;-- 67 
		T_WORD				-					;-- 68
		T_REFINE			-					;-- 69
		...
		T_FLOAT				TYPE_FLOAT			;-- 76
		T_FLOAT_SP			TYPE_FLOAT			;-- 77
		T_TUPLE				TYPE_TUPLE			;-- 78
		T_DATE				TYPE_DATE			;-- 79
		T_PAIR				TYPE_PAIR			;-- 80
		T_TIME				TYPE_TIME			;-- 81
		T_MONEY				TYPE_MONEY			;-- 82
		T_TAG				TYPE_TAG			;-- 83
		T_URL				TYPE_URL			;-- 84
		T_EMAIL				TYPE_EMAIL			;-- 85
		T_HEX				TYPE_INTEGER		;-- 86
	]
