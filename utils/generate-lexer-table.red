...
context [
	...
	;-- State ------------- Predicted type ----
		...
		S_SIGN				TYPE_WORD			;-- 39
		S_DOTWORD			TYPE_WORD			;-- 40
		S_DOTDEC			TYPE_FLOAT			;-- 41
		S_WORD_1ST			TYPE_WORD			;--	42
		S_WORD				TYPE_WORD			;-- 43
		S_WORDSET			TYPE_SET_WORD		;-- 44
		S_URL				TYPE_URL			;-- 45
		S_EMAIL				TYPE_EMAIL			;-- 46
		S_PATH				TYPE_PATH			;-- 47
		S_PATH_NUM			TYPE_INTEGER		;--	48
		S_PATH_W1ST			TYPE_WORD			;-- 49
		S_PATH_WORD			TYPE_WORD			;-- 50
		S_PATH_SHARP		TYPE_ISSUE			;--	51
		S_PATH_SIGN			TYPE_WORD			;--	52
		--EXIT_STATES--		-					;-- 53
		T_EOF				-					;-- 54
		T_ERROR				-					;-- 55
		T_BLK_OP			-					;-- 56
		...
		T_PAR_CL			-					;-- 59
		T_MSTR_OP			-					;-- 60
		T_MSTR_CL			TYPE_STRING			;-- 61
		T_MAP_OP			-					;-- 62
		T_PATH				-					;-- 63
		T_CONS_MK			-					;-- 64
		T_CMT				-					;-- 65
		T_INTEGER			TYPE_INTEGER		;-- 66 
		T_WORD				-					;-- 67
		T_REFINE			-					;-- 68
		T_ISSUE				TYPE_ISSUE			;-- 69
		T_STRING			TYPE_STRING			;-- 70
		T_FILE				TYPE_FILE			;-- 71
		T_BINARY			TYPE_BINARY			;-- 72
		T_CHAR				TYPE_CHAR			;-- 73
		T_PERCENT			TYPE_PERCENT		;-- 74
		T_FLOAT				TYPE_FLOAT			;-- 75
		T_FLOAT_SP			TYPE_FLOAT			;-- 76
		T_TUPLE				TYPE_TUPLE			;-- 77
		T_DATE				TYPE_DATE			;-- 78
		T_PAIR				TYPE_PAIR			;-- 79
		T_TIME				TYPE_TIME			;-- 80
		T_MONEY				TYPE_MONEY			;-- 81
		T_TAG				TYPE_TAG			;-- 82
		T_URL				TYPE_URL			;-- 83
		T_EMAIL				TYPE_EMAIL			;-- 84
		T_HEX				TYPE_INTEGER		;-- 85
	]
