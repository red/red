...
;Test Case PRF-1:
	...
	--test-- "PRF-1-HMAC-SHA-256" --assert expected = checksum/with data 'sha256 key

	expected: #{
		AFD03944D84895626B0825F4AB46907F15F9DADBE4101EC682AA034C7CEBC59C
		FAEA9EA9076EDE7F4AF152E8B2FA9CB6
	}
	--test-- "PRF-1-HMAC-SHA-384" --assert expected = checksum/with data 'sha384 key

	expected: #{
		87AA7CDEA5EF619D4FF0B4241A1D6CB02379F4E2CE4EC2787AD0B30545E17CDE
		DAA833B7D6B8A702038B274EAEA3F4E4BE9D914EEB61F1702E696C203A126854
	}
	--test-- "PRF-1-HMAC-SHA-512" --assert expected = checksum/with data 'sha512 key
...
;Test Case PRF-2:
	...
	--test-- "PRF-2-HMAC-SHA-256" --assert expected = checksum/with data 'sha256 key

	expected: #{
		AF45D2E376484031617F78D2B58A6B1B9C7EF464F5A01B47E42EC3736322445E
		8E2240CA5E69E2C78B3239ECFAB21649
	}
	--test-- "PRF-2-HMAC-SHA-384" --assert expected = checksum/with data 'sha384 key

	expected: #{
		164B7A7BFCF819E2E395FBE73B56E0A387BD64222E831FD610270CD7EA250554
		9758BF75C05A994A6D034F65F8F0E6FDCAEAB1A34D4A6B4B636E070A38BCE737
	}
	--test-- "PRF-2-HMAC-SHA-512" --assert expected = checksum/with data 'sha512 key
...
;Test Case PRF-3:
	...
	--test-- "PRF-3-HMAC-SHA-256" --assert expected = checksum/with data 'sha256 key

	expected: #{
		88062608D3E6AD8A0AA2ACE014C8A86F0AA635D947AC9FEBE83EF4E55966144B
		2A5AB39DC13814B94E3AB6E101A34F27
	}
	--test-- "PRF-3-HMAC-SHA-384" --assert expected = checksum/with data 'sha384 key

	expected: #{
		FA73B0089D56A284EFB0F0756C890BE9B1B5DBDD8EE81A3655F83E33B2279D39
		BF3E848279A722C806B485A47E67C807B946A337BEE8942674278859E13292FB
	}
	--test-- "PRF-3-HMAC-SHA-512" --assert expected = checksum/with data 'sha512 key
...
;Test Case PRF-4:
	...
	--test-- "PRF-4-HMAC-SHA-256" --assert expected = checksum/with data 'sha256 key

	expected: #{
		3E8A69B7783C25851933AB6290AF6CA77A9981480850009CC5577C6E1F573B4E
		6801DD23C4A7D679CCF8A386C674CFFB
	}
	--test-- "PRF-4-HMAC-SHA-384" --assert expected = checksum/with data 'sha384 key

	expected: #{
		B0BA465637458C6990E5A8C5F61D4AF7E576D97FF94B872DE76F8050361EE3DB
		A91CA5C11AA25EB4D679275CC5788063A5F19741120C4F2DE2ADEBEB10A298DD
	}
	--test-- "PRF-4-HMAC-SHA-512" --assert expected = checksum/with data 'sha512 key
...
;Test Case PRF-5:
	...
	--test-- "PRF-5-HMAC-SHA-256" --assert expected = checksum/with data 'sha256 key

	expected: #{
		3ABF34C3503B2A23A46EFC619BAEF897F4C8E42C934CE55CCBAE9740FCBC1AF4
		CA62269E2A37CD88BA926341EFE4AEEA
	}
	--test-- "PRF-5-HMAC-SHA-384" --assert expected = checksum/with data 'sha384 key
	...
	--test-- "PRF-5-HMAC-SHA-512" --assert expected = checksum/with data 'sha512 key
...
;Test Case PRF-6:
	...
	--test-- "PRF-6-HMAC-SHA-256" --assert expected = checksum/with data 'sha256 key

	expected: #{
		4ECE084485813E9088D2C63A041BC5B44F9EF1012A2B588F3CD11F05033AC4C6
		0C2EF6AB4030FE8296248DF163F44952
	}
	--test-- "PRF-6-HMAC-SHA-384" --assert expected = checksum/with data 'sha384 key

	expected: #{
		80B24263C7C1A3EBB71493C1DD7BE8B49B46D1F41B4AEEC1121B013783F8F352
		6B56D037E05F2598BD0FD2215D6A1E5295E64F73F63F0AEC8B915A985D786598
	}
	--test-- "PRF-6-HMAC-SHA-512" --assert expected = checksum/with data 'sha512 key
...
;Test Case PRF-7:
	...
	--test-- "PRF-7-HMAC-SHA-256" --assert expected = checksum/with data 'sha256 key

	expected: #{
		6617178E941F020D351E2F254E8FD32C602420FEB0B8FB9ADCCEBB82461E99C5
		A678CC31E799176D3860E6110C46523E
	}
	--test-- "PRF-7-HMAC-SHA-384" --assert expected = checksum/with data 'sha384 key

	expected: #{
		E37B6A775DC87DBAA4DFA9F96E5E3FFDDEBD71F8867289865DF5A32D20CDC944
		B6022CAC3C4982B10D5EEB55C3E4DE15134676FB6DE0446065C97440FA8C6A58
	}
	--test-- "PRF-7-HMAC-SHA-512" --assert expected = checksum/with data 'sha512 key
