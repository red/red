...
===start-group=== "Reflection"
	...
	--test-- "fun-ref-2"
		...
		--assert blk = [
			series [series! bitset! port!] value [any-type!] /part length [number! series!]
			/only /dup count [integer!] return: [series! port! bitset!]
		]
...
===start-group=== "function spec validation"
	...
	--test-- "fsv12"
        --assert error? try [do [function? func [a return: [integer!] /b][]]]
	--test-- "fsv13"
	...
	--test-- "#3595"
		--assert function? do [func [return: [block!] "string"][]]
		--assert function? do [func [return: [block!] "string" /local word][]]
		--assert error? try [do [func [return: [block!] "string" word][]]]
		
	--test-- "#5363"
		--assert error? try [do [func [return: [block!] "string" word /local b][]]]
