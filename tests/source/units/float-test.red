...
===start-group=== "float-divide"
	...
	--test-- "float-divide 37"
		i: 2.2250738585072014e-308
		j: 1.1
		base: to-float #either any [config/target = 'ARM config/target = 'X86-64] [#{000E8BA2E8BA2E8B}][#{000E8BA2E8BA2E8C}] ;;FIXME: workaround #4041
	...
	--test-- "float-divide 38"
		i: 2.2250738585072014e-308
		j: -1.1
		base: to-float #either any [config/target = 'ARM config/target = 'X86-64] [#{800E8BA2E8BA2E8B}][#{800E8BA2E8BA2E8C}] ;;FIXME: workaround #4041
		--assert strict-equal? base 2.2250738585072014e-308 / -1.1
		--assert strict-equal? base divide 2.2250738585072014e-308 -1.1
		--assert strict-equal? base i / j
		--assert strict-equal? base divide i j
