...
===start-group=== "dates creation"
	...
	--test-- "make2"	--assert 3-Feb-1978				  = make date! [3 2 1978]
	--test-- "make3"	--assert 3-Feb-1978/5:00:00 	  = make date! [1978 2 3 5:0:0]
	--test-- "make4"	--assert 3-Feb-1978/5:00:00+08:00 = make date! [1978 2 3 5:0:0 8]
	--test-- "make5"	--assert 3-Feb-1978/5:21:31+8:15  = make date! [1978 2 3 5:21:31 8 15]
	--test-- "make6"	--assert 3-Feb-1978/5:21:31.5-6:30 = make date! [1978 2 3 5:21:31.5 -6 30]
	--test-- "make7"	--assert 3-Feb-1978/5:00:00		  = make date! [1978 2 3 5]
	--test-- "make8"	--assert 3-Feb-1978/5:20:00 	  = make date! [1978 2 3 5 20]
	--test-- "make9"	--assert 3-Feb-1978/5:20:30 	  = make date! [1978 2 3 5 20 30]
	--test-- "make10"	--assert 3-Feb-1978/5:20:30-2:15  = make date! [1978 2 3 5 20 30 -2:15]
	--test-- "make11"	--assert 3-Feb-1978/5:20:30+3:30  = make date! [1978 2 3 5 20 30 3:30]
	--test-- "make12"	--assert 3-Feb-1978/5:20:30-4:00  = make date! [1978 2 3 5 20 30 -4]
	--test-- "make13"	--assert 3-Feb-1978/5:20:30+4:00  = make date! [1978 2 3 5 20 30 4]
	--test-- "make14"	--assert 3-Feb-1978/5:20:30+4:15  = make date! [1978 2 3 5 20 30 4 15]
	--test-- "make15"	;; assert 3-Feb-1978/5:20:30.2+4:15  = make date! [1978 2 3 5 20 30.2 4 15]
						;; use the above unified test once compiler is self-hosted (R2 cannot handle decimal seconds)
						dm15: make date! [1978 2 3 5 20 30.2 4 15]
						--assertf~= dm15/second 30.2 1e-10
						--assert dm15/hour == 5
						--assert dm15/minute == 20
						--assert dm15/zone == 4:15
	
	--test-- "make20"	--assert error? try [make date! [1981]]
	--test-- "make21"	--assert error? try [make date! [1981 2]]
	--test-- "make22"	--assert error? try [make date! [1981 2 9.5]]
	--test-- "make23"	--assert error? try [make date! [1981 2 2 9.5]]
	--test-- "make26"	--assert error? try [make date! [1981 2 2 2:0 1.2]]
	--test-- "make27"	--assert error? try [make date! [1981 2 2 2:0 1 1:2]]
	--test-- "make28"	--assert error? try [make date! [1981 2 2 2:0 1 1.2]]
	--test-- "make29"	--assert error? try [make date! [1981 2 2 2:0 1 2 1:2]]
	--test-- "make30"	--assert error? try [make date! [1981 2 2 2:0 1 2 1.2]]
	--test-- "make31"	--assert error? try [make date! [1981 2 2 5 20.5]]
	--test-- "make32"	--assert error? try [make date! [1981 2 2 5 4:15]]
	--test-- "make33"	--assert error? try [make date! [1981 2 2 5 20 4:15]]
	--test-- "make34"	--assert error? try [make date! [1981 2 2 5 20 30 4.15]]
	--test-- "make35"	--assert error? try [make date! [1981 2 2 5 20 30 4:15 1]]
	--test-- "make36"	--assert error? try [make date! [1981 2 2 5 20 30 4:15 1:15]]
	--test-- "make37"	--assert error? try [make date! [1981 2 2 5 20 30 4:15 10.2]]
	--test-- "make38"	--assert error? try [make date! [1981 2 2 5 20 30 4 2:0]]
	--test-- "make39"	--assert error? try [make date! [1981 2 2 5 20 30 4 2.1]]
	--test-- "make40"	--assert error? try [make date! [1981 2 2 5 20 30 4 2 3]]
	--test-- "make41"	--assert error? try [make date! [1981 2 2 5 20 30 4 2 3:15]]
	--test-- "make42"	--assert error? try [make date! [1981 2 2 5 20 30 4 2 3.1]]
	--test-- "make43"	--assert error? try [make date! [1981 2 29]]
	--test-- "make44"	--assert error? try [make date! [1 2 2017 23 70 0 4:30]]
	--test-- "make45"	--assert error? try [make date! [1 2 2017 23:70:0 4:30]]
	
	--test-- "make50"	--assert 3-Feb-1978				  = make date! [3 2 1978]
	--test-- "make51"	--assert 3-Feb-1978/5:20:30+4:00  = make date! [3 2 1978 5 20 30 4]
	--test-- "make52"	--assert 1-Jan-0001 			  = make date! [1 1 1]
	--test-- "make53"	--assert 1-Jan-0002 			  = make date! [1 1 2]
	--test-- "make54"	--assert 30-Jan-0002			  = make date! [30 1 2]
	--test-- "make55"	--assert error? try [make date! [32 1 2]]
	--test-- "make56"	--assert error? try [make date! [99 1 2]]
	--test-- "make57"	--assert 2-Jan-0100				  = make date! [100 1 2]
	--test-- "make58"	--assert 1-Jan-2024/0:00:00.1	  = make date! [2024 1 1 0 0 0.1]
