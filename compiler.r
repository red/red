...
red: context [
	...
	;-- Name ---------- Entry file -------------------- OS availability -----
		...
		L10N			%modules/l10n/l10n.red          [Windows macOS Linux Syllable FreeBSD NetBSD]	;-- L10N-Core + Locales
		L10N-Core		%modules/l10n/core.red          [Windows macOS Linux Syllable FreeBSD NetBSD]	;-- all Locales/ in one file
		Locales			%modules/l10n/locales.red       [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/af		%modules/l10n/locales/af.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/af_ZA	%modules/l10n/locales/af_ZA.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ar		%modules/l10n/locales/ar.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ar_AE	%modules/l10n/locales/ar_AE.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ar_EG	%modules/l10n/locales/ar_EG.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ar_SA	%modules/l10n/locales/ar_SA.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/bg		%modules/l10n/locales/bg.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/bg_BG	%modules/l10n/locales/bg_BG.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/cs		%modules/l10n/locales/cs.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/cs_CZ	%modules/l10n/locales/cs_CZ.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/de		%modules/l10n/locales/de.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/de_DE	%modules/l10n/locales/de_DE.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/en		%modules/l10n/locales/en.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/en_AU	%modules/l10n/locales/en_AU.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/en_CA	%modules/l10n/locales/en_CA.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/en_GB	%modules/l10n/locales/en_GB.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/en_US	%modules/l10n/locales/en_US.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		...
		Locales/he		%modules/l10n/locales/he.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/he_IL	%modules/l10n/locales/he_IL.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/hi		%modules/l10n/locales/hi.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/hi_IN	%modules/l10n/locales/hi_IN.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/it		%modules/l10n/locales/it.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/it_IT	%modules/l10n/locales/it_IT.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ja		%modules/l10n/locales/ja.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ja_JP	%modules/l10n/locales/ja_JP.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ko		%modules/l10n/locales/ko.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ko_KR	%modules/l10n/locales/ko_KR.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/pl		%modules/l10n/locales/pl.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/pl_PL	%modules/l10n/locales/pl_PL.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/pt		%modules/l10n/locales/pt.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/pt_BR	%modules/l10n/locales/pt_BR.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/red		%modules/l10n/locales/red.red   [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/root	%modules/l10n/locales/root.red  [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ru		%modules/l10n/locales/ru.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ru_BY	%modules/l10n/locales/ru_BY.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ru_RU	%modules/l10n/locales/ru_RU.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/ru_UA	%modules/l10n/locales/ru_UA.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/tr		%modules/l10n/locales/tr.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/tr_TR	%modules/l10n/locales/tr_TR.red [Windows macOS Linux Syllable FreeBSD NetBSD]
		Locales/zh		%modules/l10n/locales/zh.red    [Windows macOS Linux Syllable FreeBSD NetBSD]
	]
