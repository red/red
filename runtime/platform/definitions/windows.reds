...
#define HIDP_ERROR_CODES(SEV CODE)					[(SEV << 28) or (FACILITY_HID_ERROR_CODE << 16) or CODE]
#define HIDP_STATUS_SUCCESS							[HIDP_ERROR_CODES(00h 0)]
#define HIDP_STATUS_NULL							[HIDP_ERROR_CODES(08h 1)]
#define HIDP_STATUS_INVALID_PREPARSED_DATA			[HIDP_ERROR_CODES(0Ch 1)]
#define HIDP_STATUS_INVALID_REPORT_TYPE				[HIDP_ERROR_CODES(0Ch 2)]
#define HIDP_STATUS_INVALID_REPORT_LENGTH			[HIDP_ERROR_CODES(0Ch 3)]
#define HIDP_STATUS_USAGE_NOT_FOUND					[HIDP_ERROR_CODES(0Ch 4)]
#define HIDP_STATUS_VALUE_OUT_OF_RANGE				[HIDP_ERROR_CODES(0Ch 5)]
#define HIDP_STATUS_BAD_LOG_PHY_VALUES				[HIDP_ERROR_CODES(0Ch 6)]
#define HIDP_STATUS_BUFFER_TOO_SMALL				[HIDP_ERROR_CODES(0Ch 7)]
#define HIDP_STATUS_INTERNAL_ERROR					[HIDP_ERROR_CODES(0Ch 8)]
#define HIDP_STATUS_I8042_TRANS_UNKNOWN				[HIDP_ERROR_CODES(0Ch 9)]
#define HIDP_STATUS_INCOMPATIBLE_REPORT_ID			[HIDP_ERROR_CODES(0Ch 0Ah)]
#define HIDP_STATUS_NOT_VALUE_ARRAY					[HIDP_ERROR_CODES(0Ch 0Bh)]
#define HIDP_STATUS_IS_VALUE_ARRAY					[HIDP_ERROR_CODES(0Ch 0Ch)]
#define HIDP_STATUS_DATA_INDEX_NOT_FOUND			[HIDP_ERROR_CODES(0Ch 0Dh)]
#define HIDP_STATUS_DATA_INDEX_OUT_OF_RANGE			[HIDP_ERROR_CODES(0Ch 0Eh)]
#define HIDP_STATUS_BUTTON_NOT_PRESSED				[HIDP_ERROR_CODES(0Ch 0Fh)]
#define HIDP_STATUS_REPORT_DOES_NOT_EXIST			[HIDP_ERROR_CODES(0Ch 10h)]
#define HIDP_STATUS_NOT_IMPLEMENTED					[HIDP_ERROR_CODES(0Ch 20h)]
...
#enum POLICY-TYPE! [
	SHORT-PACKET-TERMINATE: 1
	AUTO-CLEAR-STALL
	PIPE-TRANSFER-TIMEOUT
