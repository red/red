...
iocp: context [
	...
	create: func [
		...
		p/maxn: 65536
		p/port: platform/CreateIoCompletionPort INVALID_HANDLE null null 0
	...
	close: func [
		...
		platform/CloseHandle as-integer p/port
		p/port: null
		if p/events <> null [
	...
	post: func [
		...
		0 <> platform/PostQueuedCompletionStatus p/port data/transferred null as OVERLAPPED! data
	]
	...
	bind: func [
		...
		port: platform/CreateIoCompletionPort handle p/port null 0
		either port = p/port [
	...
	wait: func [
		...
		cnt: 0
		res: platform/GetQueuedCompletionStatusEx p/port p/events p/evt-cnt :cnt timeout no
