...
context [
	manifest-template: decompress #{
		
		58040000
	} 'gzip

	;on-file-written: func [job [object!] file [file!] /local file-sum chk-sum offset buffer res][
	;	if all [
	;		system/platform = 'Windows							;-- only when running the toolchain on Windows
	...
	build-section-header: func [job [object!] name [word!] spec [block!] /local sh s][
		...
		sh/raw-data-size: 	to-integer file-align * round/ceiling (length? spec/2) / file-align
