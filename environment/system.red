	...
	catalog: context [
		...
		errors: context [
			...
			syntax: object [
				code:				200
				type:				"Syntax Error"
				invalid:			["(line" :arg1 ") invalid" :arg2 "at" :arg3]
				missing:			["(line" :arg1 ") missing" :arg2 "at" :arg3]
				...
				malconstruct:		["(line" :arg1 ") invalid construction spec:" :arg2]
				bad-char:			["(line" :arg1 ") invalid character in:" :arg2]
			]
			script: object [
				code:				300
				type:				"Script Error"
